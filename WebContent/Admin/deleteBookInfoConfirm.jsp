...
<%
	String deleteISBN = String.valueOf(request.getParameter("ISBN"));
deleteISBN = new String(deleteISBN.getBytes("ISO-8859-1"), "UTF-8");
	if(deleteISBN.equals("null"))
		deleteISBN="";
	session.setAttribute("deleteISBN", deleteISBN);
%>
...
<title>線上書籍借閱系統 - 書籍刪除</title>

</head>
<body>
<form name="deleteAccountConfirmForm" action="deleteBookInfoSQL.jsp" method="post">
<table align="center">
<tbody>
<tr><td><h1><b>確定刪除<%=deleteISBN %>?</b></h1><br></td></tr>
<tr>
	<td>
