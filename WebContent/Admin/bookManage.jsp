...
<%
	String orderURL = "bookManage.jsp";
	String formString = "<form name='bookManageForm' action='";
	...
	out.print("<input type ='button' onclick=\"javascript:location.href='insertBookInfo.jsp'\" value='新增書籍'></input>");
	out.print("</form>");
%>
...
<%
	...
	try {
		...
		while(rs.next()){
			...
			out.print("<td><a href='updateBookInfo.jsp?ISBN=" + ISBN
					+ "'>修改</a></td>");
			out.print("<td><a href='deleteBookInfoConfirm.jsp?ISBN=" + ISBN
						+ "'>刪除</a></td>");
			out.print("</tr>");
		}
		out.print("</table>");
